#  Develop a function to read file from given file and return the contents
#  Develop a function to parse the contents of the file and place them in seperate elements
...
# Time Complexity: O(N), where N is the amount of characters in the file or the length of the contents of the file data given. Linear time complexity
